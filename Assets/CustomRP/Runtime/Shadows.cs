...
public class Shadows : MonoBehaviour
{
    ...
    private static int shadowDistancedFadeId = Shader.PropertyToID("_ShadowDistanceFade");
    ...
    private void RenderDirectionalShadows()
    {
        ...
        buffer.SetGlobalVector(shadowDistancedFadeId, new Vector4(1f/settings.maxDistance, 1f/settings.distanceFade, 1f/ (1f - f * f)));
